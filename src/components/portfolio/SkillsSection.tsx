...
const frontendSkills = ['React', 'JavaScript', 'TypeScript', 'Tailwind', 'CSS', 'Figma', 'Angular', 'Next'];
const backendSkills = ['Node', '.NET', 'Express', 'Java', 'REST APIs', 'SQL Server', 'MongoDB'];
    ...
    <section id="skills" className="scroll-mt-40">
      <div className="section-surface animate-fade-up">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-white/30 bg-white/70 p-6 shadow-lg shadow-slate-900/10 transition-transform duration-500 hover:-translate-y-1 dark:border-white/10 dark:bg-slate-900/60">
